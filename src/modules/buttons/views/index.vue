<template>
  <div class="p-2">
    <div class="h-auto flex flex-wrap border border-slate-50 bg-white shadow-lg mx-auto rounded">
      <div>
    ...
    <div
      class="h-auto flex flex-wrap border border-slate-50 bg-white shadow-lg mt-5 mx-auto rounded"
    >
      <div>
        <el-container class="font-semibold text-lg text-indigo-900 px-6 pt-4">
