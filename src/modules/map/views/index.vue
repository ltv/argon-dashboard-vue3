<template>
  <div class="map w-full">
    <GoogleMap :api-key="googleApi" class="w-full h-[500px] border-0" :center="center" :zoom="15">
...
.map {
  @apply w-[96%] rounded-lg overflow-hidden p-0 mt-[25px] mx-auto border-0 #{!important};
}
</style>
