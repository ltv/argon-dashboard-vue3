            ...
            <el-card class="box-card text-center relative" :body-style="{ padding: '0px' }">
              ...
              <div class="p-8">
                <div class="text-center text-indigo-900">
                  <h5 class="text-lg font-semibold">Tywin Lannister<span class="font-thin">, 67</span>
                  </h5><div class="font-light">
                    <el-icon :size="15">
                      <Location />
                    </el-icon>
        ...
        <div class="col-span-4">
          ...
          <div class="pt-6">
            ...
            >
              ...
              <el-divider />
              <el-link :underline="false" class="text-slate-400 text-base hover:text-slate-500 pb-4">Request a demo</el-link>
            </el-card>
          </div>
        </div>
      </div>
