module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      grilBlackItalic: ['GrilroyBlackItalic', 'sans-serif'],
      grilBlack: ['GrilroyBlack', 'sans-serif'],
      grilBoldItalic: ['GrilroyBoldItalic', 'sans-serif'],
      grilBold: ['GrilroyBold', 'sans-serif'],
      grilHeavyItalic: ['GrilroyHeavyItalic', 'sans-serif'],
      grilHeavy: ['GrilroyHeavy', 'sans-serif'],
      grilItalic: ['GrilroyItalic', 'sans-serif'],
      grilLightItalic: ['GrilroyLightItalic', 'sans-serif'],
      grilLight: ['GrilroyLight', 'sans-serif'],
      grilMediumItalic: ['GrilroyMediumItalic', 'sans-serif'],
      grilMedium: ['GrilroyMedium', 'sans-serif'],
      grilSemiboldItalic: ['GrilroySemiBoldItalic', 'sans-serif'],
      grilSemibold: ['GrilroySemiBold', 'sans-serif'],
      grilThinItalic: ['GrilroyThinItalic', 'sans-serif'],
      grilThin: ['GrilroyThin', 'sans-serif'],
      grilXboldItalic: ['GrilroyXboldItalic', 'sans-serif'],
      grilXbold: ['GrilroyXbold', 'sans-serif'],
      grilXlightItalic: ['GrilroyXlightItalic', 'sans-serif'],
      grilXlight: ['GrilroyXlight', 'sans-serif'],
    },
  },
